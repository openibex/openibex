...
const platformIndexers: Record<string, new (assetArtifact: AssetArtifact, eventName: string, callback:  (...args: any[]) => Promise<void> , startBlock: number | string, bloomFilters?: any) => OiEventIndexer> = {};
 ...
 * @param startBlock Start Block, default 'latest'
...
export async function indexEvents(
  ...
  startBlock: number | string = 'latest',
  bloomFilters?: any
) {
